...
namespace ButikOtelRezervasyon3
{
    class Rezervasyon
    {
        ...
        public void BugunIcınHızlıRezervasyon()
        {
            bool bosOdaYok = true;
            for (int i = 0; i < odaSayisi; i++)
            {
        ...
        public void IkıTarihArasıRezervasyon()
        {
                        ...
                        case '3':
                            {
                                ...
                                rezervasyon.BugunIcınHızlıRezervasyon();
                                break;
                            }
                        case '4':
                            {
                                ...
                                rezervasyon.IkıTarihArasıRezervasyon(DateTime.Today, DateTime.Today);
                                break;
                            }
                    }
                }
